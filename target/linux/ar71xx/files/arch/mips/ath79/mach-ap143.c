...
#define AP143_GPIO_BTN_RESET		17
...
static void __init ap143_setup(void)
{
	...
	ath79_eth0_data.phy_mask = AP143_SWAP_PHY4 ? BIT(0) : BIT(4);
	...
	ath79_switch_data.phy_poll_mask |= AP143_SWAP_PHY4 ? BIT(0) : BIT(4);
